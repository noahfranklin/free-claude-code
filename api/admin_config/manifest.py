...
_NON_PROVIDER_FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        "FCC_MODEL_HEALTH_ENABLED",
        "Model Health Tracking",
        "runtime",
        "boolean",
        settings_attr="model_health_enabled",
        default="true",
        description="Track working models and demote ones that fail during use.",
    ),
    ConfigFieldSpec(
        "FCC_MODEL_LIST_MODE",
        "Model List Mode",
        "runtime",
        "select",
        settings_attr="model_list_mode",
        default="exclude_unhealthy",
        options=("all", "exclude_unhealthy", "healthy_only"),
        description="How /v1/models filters models by tracked health.",
    ),
    ConfigFieldSpec(
        "FCC_MODEL_HEALTH_COOLDOWN",
        "Model Health Cooldown (s)",
        "runtime",
        "number",
        settings_attr="model_health_cooldown_seconds",
        default="600",
        advanced=True,
        restart_required=True,
        description="How long a demoted model stays hidden before re-probing.",
    ),
    ConfigFieldSpec(
        "FCC_MODEL_HEALTH_PROBE_TIMEOUT",
        "Model Health Probe Timeout (s)",
        "runtime",
        "number",
        settings_attr="model_health_probe_timeout",
        default="20",
        advanced=True,
    ),
    ConfigFieldSpec(
        "FCC_MODEL_HEALTH_PROBE_CONCURRENCY",
        "Model Health Probe Concurrency",
        "runtime",
        "number",
        settings_attr="model_health_probe_concurrency",
        default="8",
        advanced=True,
    ),
    ConfigFieldSpec(
